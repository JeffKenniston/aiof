...
Always verify your findings. When done, call SendReply to give a detailed answer, then call TaskComplete.`, GetPersonaPrompt(agentName, "specialist"), input, projectDir)
	...
	chat, err := r.client.Chats.Create(ctx, "gemini-3.1-pro-preview", config, nil)
	if err != nil {
