              ...
              <div>
                ...
                <div className="bg-surface-overlay border border-border-default rounded p-4">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <div>
                      <div className="text-text-primary font-medium">Save to <code className="bg-surface-base px-1 py-0.5 rounded text-accent-amber">.aiof/project.json</code></div>
                      <div className="text-xs text-text-muted mt-1">If enabled, project settings will also be written to the codebase root, allowing you to commit and share orchestration workflows with your team.</div>
                    </div>
                  </label>
                </div>
              </div>
