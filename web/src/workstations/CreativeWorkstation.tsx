    ...
    <div className="w-full h-full flex bg-[#030105] text-text-primary overflow-hidden relative font-sans">
      ...
      <AnimatePresence initial={false}>
        {leftOpen && (
          ...
          >
            <AssetLibrary onClose={() => setLeftOpen(false)} assets={assets} onSelectAsset={setActiveAsset} />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="flex-1 flex flex-col h-full relative z-10">
        ...
        <div className="flex-1 bg-transparent flex items-center justify-center p-8 lg:p-12">
          <CanvasArea activeAsset={activeAsset} />
        </div>
      </div>
      ...
      <AnimatePresence initial={false}>
        {rightOpen && (
          ...
          >
            <GenerationPalette onClose={() => setRightOpen(false)} onGenerate={handleGenerate} />
          </motion.div>
        )}
      </AnimatePresence>
    </div>
