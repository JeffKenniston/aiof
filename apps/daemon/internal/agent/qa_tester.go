...
Always verify your tests pass. When done, call TaskComplete.`, GetPersonaPrompt(agentName, "specialist"), input, projectDir)
	...
	chat, err := q.client.Chats.Create(ctx, "gemini-3.1-pro-preview", config, nil)
	if err != nil {
